...
class NormalizeFrameTestCase(unittest.TestCase):
    def test_words_with_no_repeat(self):
        # Arrange
    ...
    def test_words_with_repeat(self):
        # Arrange
    ...
    def test_word_data_with_no_repeat(self):
        # Arrange
    ...
    def test_word_data_with_repeat(self):
        # Arrange
    ...
    def test_data_with_no_repeat(self):
        # Arrange
